...
<head>
    ...
    <meta name="description" content="Découvrez notre atelier spécialisé dans les clarinettes, où nous offrons des services de maintenance, de location et de vente. Nos services sont disponibles en magasin uniquement et non en ligne. Venez nous rendre visite pour tous vos besoins en clarinettes." />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <a class="btn btn-primary btn-social mx-2" href="https://www.facebook.com/latelierdesclarinettes" aria-label="Suivez-nous sur Facebook"><i class="fab fa-facebook-f"></i></a>
            </div>
        </div>
    </nav>
    <!-- Masthead-->
    <header class="masthead">
        <div class="container">
            ...
            <a class="btn btn-primary btn-xl text-uppercase border-white text-dark" href="./connexion/index.php">Connectez-vous</a>
        </div>
    </header>
    <!-- Services-->
        ...
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">L'Atelier des Clarinettes vous propose la réparation, la location, la vente de clarinettes neuves ou d'occasion, ainsi que la vente d'accessoires autour de la clarinette. Professeurs et concertistes, forts d'une solide expérience en lutherie, Anne et Jocelyn Guichon axent leur expertise sur la clarinette pour offrir des prestations de réparation et de conseil haut de gamme.
                    <br>Soutenus par les grandes maisons Buffet Crampon et BG, l'Atelier des clarinettes est à votre disposition pour vous faire découvrir une large gamme d'accessoires sur place. Il peut aussi se déplacer lors de manifestations musicales.</br>
                </h3>
            </div>
