	...
	<div class="container">
		...
		<form action="formulaireInfosClient.php" method="post">
			...
			<div class="form-group">
				...
				value="<?php echo $client->getNom() ?>" required>
			</div>
			<div class="form-group">
				<label for="prenom">PRÉNOM :</label>
				<input type="text" class="form-control" id="prenom" name="prenom"
				value="<?php echo $client->getPrenom() ?>" required>
			</div>
			<div class="form-group">
				<label for="adresse">ADRESSE :</label>
				<input type="text" class="form-control" id="adresse" name="adresse"
				value="<?php echo $client->getAdresse() ?>" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				value="<?php echo $client->getTelephone() ?>"
				maxlength="10"
				placeholder="Veuillez entrer votre numéro 0612345678" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group mb-4">
				...
				placeholder="Veuillez saisir un mot de passe si vous voulez le changer.">
			</div>
            <div class="row g-2">
